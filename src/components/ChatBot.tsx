  ...
  return (
    <>
      ...
      <Button
        ...
        className={`fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full shadow-gold bg-accent hover:bg-accent/90 text-accent-foreground transition-all duration-300 ${
      ...
      {/* Chat Window */}
      <div
        className={`fixed bottom-6 right-6 z-50 w-96 h-[500px] transition-all duration-300 ${
